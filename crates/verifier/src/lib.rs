...
pub use interleave::{
    ...
    find_weak_memory_bugs, store_buffer_violations, trace_to_thread, weak_memory_nonrobustness,
    AbaWitness, AtomicityWitness, CrossEntryWitness, FreeUseWitness, StoreBufferWitness, Thread,
    WeakMemoryWitness,
};
